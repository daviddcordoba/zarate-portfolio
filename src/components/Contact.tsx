...
const Contact = () => {
  ...
  return (
    <section className='flex flex-col gap-4 '>
        ...
        <a href="https://api.whatsapp.com/send?phone=2804817252" className='flex gap-1 items-center text-[#120222] hover:text-[#120222]/80 transition duration-300' target='_blank'>
